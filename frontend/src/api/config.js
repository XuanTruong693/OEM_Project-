...
const isProduction = typeof window !== 'undefined' &&
    (window.location.hostname === 'www.oes.io.vn' || window.location.hostname === 'oes.io.vn');

// Production URLs (via Cloudflare Tunnel)
const PROD_API_URL = 'https://api.oes.io.vn/api';
const PROD_SERVER_URL = 'https://api.oes.io.vn';
const PROD_SOCKET_URL = 'https://api.oes.io.vn';
const PROD_AI_URL = 'https://ai.oes.io.vn';

...
router.get('/ai-grading-logs/missed', verifyToken, verifyRole('admin'), aiLogsController.getMissedSubmissions);
router.get('/ai-grading-logs/batch-preview', verifyToken, verifyRole('admin'), aiLogsController.getBatchRegradePreview);
...
router.post('/ai-grading-logs/batch-regrade', verifyToken, verifyRole('admin'), aiLogsController.forceRegradeBatch);
